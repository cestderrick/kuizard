...
export default async function ClassementPage({
  ...
  if (
    ...
    return (
      <main className="flex flex-col items-stretch justify-start min-h-screen px-4 pt-3 pb-12 bg-[var(--color-night)] text-[var(--color-lavender)]">
  ...
  return (
    <main className="flex flex-col items-stretch justify-start min-h-screen px-3 sm:px-4 pt-2 pb-8 sm:pt-3 sm:pb-12 bg-[var(--color-night)] text-[var(--color-lavender)] relative overflow-hidden">
      {/* Halos magiques */}
      <div
        aria-hidden
